...
1. Make sure the JAVA_HOME, ANDROID_HOME, ANDROID_NDK, GRADLE_HOME are setup correctly on your Enviroment Variables (Windows - Control panel; Mac - ~/.bash_profile )
